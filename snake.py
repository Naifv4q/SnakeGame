...
class Snake:
    def __init__(self):
        #Initiating snake part list.
        self.snake_parts=[]
        #Calling a create_snake() function to make a snake
        self.create_snake()
        #Assigning the head to a single variable, instead of calling the whole list everytime.
    ...
    def create_snake(self):
        ...
        #Initaiting every body part of the snake and assigning them to a snake_parts list.
        self.snake_parts = [snake_head, snake_body, snake_tail]

        #go_left variable is set to decrement every part by 20 pixels to the left.
        go_left = 0
        #Snake values are set in one loop.
    ...
    def move(self):
            ...
            #Making the snake move by the constant distance, which is 20 pixels
    ...
    #This function adds a tail object to the snake on call.
    def add_tail(self):
        new_tail=Turtle()
