...
#Here the screen stops updating, so it can only be updated when the snake is moving, the updating part happens in line 32 and below
...
#Initiating a food object, that renders randomly withing the screen borders set in line 9.
my_food = Food()
...
while keep_going:
    ...
    #the program resets the game for collision with snake body and a new run starts.
    for part in snake.snake_parts[1:]:
        if snake.head.distance(part) < 10:
            # my_scoreboard.show_game_over()
